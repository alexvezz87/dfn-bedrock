            ...
            if (! $need_split && $selected_slot) {
                ...
                $wpdb->insert(
                    ...
                    [
                        ...
                        'customer_name'    => function_exists('dfn_sanitize_name') ? dfn_sanitize_name($order->get_billing_first_name() . ' ' . $order->get_billing_last_name()) : trim($order->get_billing_first_name() . ' ' . $order->get_billing_last_name()),
