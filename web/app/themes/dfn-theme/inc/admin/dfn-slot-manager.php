...
{
    if (! current_user_can('manage_options') && ! current_user_can('dfn_act_events_manage') && ! current_user_can('dfn_manage_events') && ! (function_exists('dfn_user_can') && dfn_user_can('dfn_act_events_manage'))) {
