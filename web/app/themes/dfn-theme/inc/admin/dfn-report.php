                    ...
                    <tbody>
                        ...
                        <?php else : ?>
                            <?php foreach ($bookings as $b) :
                                ...
                                if ($b->payment_method === 'in_loco_cash') {
                                    $payment_method_label = '💵 Cassa (Contanti)';
                                } elseif ($b->payment_method === 'in_loco_pos') {
                                    $payment_method_label = '💳 Cassa (POS)';
                                } elseif ($b->payment_method === 'dfn_in_loco') {
                                    $payment_method_label = '🕒 Cassa (Sospeso)';
                                } else {
