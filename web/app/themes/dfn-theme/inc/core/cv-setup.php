...
// child_theme_configurator_css disabilitato: lo stylesheet principale è gestito da dfn_enqueue_parent_styles() in dfn-setup.php
...
function cv_crea_ruolo_operatore_scanner(): void
{
    ...
    add_role('cv_scanner', 'Verificatore Biglietti', ['read' => true, 'cv_use_scanner' => true]);
