...
if ( class_exists( 'WC_Payment_Gateway' ) ) {
    ...
    class DFN_Gateway_In_Loco extends WC_Payment_Gateway {
        ...
        public function __construct() {
            ...
            $this->method_title       = __( "Pagamento all'Ingresso", 'dfn-theme' );
            $this->method_description = __( "Consente di prenotare i biglietti online ed effettuare il saldo direttamente all'ingresso dell'evento (Botteghino).", 'dfn-theme' );
        ...
        public function init_form_fields() {
            $this->form_fields = array(
                'enabled' => array(
                    ...
                    'type'    => 'checkbox',
                    'label'   => __( 'Abilita il Pagamento all\'Ingresso', 'dfn-theme' ),
                    'default' => 'yes',
                ),
                'title' => array(
                    ...
                    'default'     => __( "Pagamento all'Ingresso", 'dfn-theme' ),
                    'desc_tip'    => true,
                ),
                'description' => array(
                    ...
                    'default'     => __( "Prenota ora gratuitamente. Salderai il contributo direttamente all'ingresso dell'evento in contanti o carta.", 'dfn-theme' ),
                    'desc_tip'    => true,
                ),
                'instructions' => array(
                    ...
                    'default'     => __( "La tua prenotazione è confermata! Mostra il codice QR ricevuto via email all'ingresso dell'evento per effettuare il saldo ed entrare velocemente.", 'dfn-theme' ),
                    'desc_tip'    => true,
                ),
            );
        }
