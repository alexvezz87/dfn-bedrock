...
function dfn_render_evento_shortcode( $atts ): string {
    ...
    <div class="dfn-booking-widget" 
        ...
        $gallery_img_ids = ! empty( $gallery_ids_str ) ? array_filter( explode( ',', $gallery_ids_str ) ) : array();
                ...
                <?php else : ?>
                    <form class="dfn-booking-form" style="position: relative;">
                        ...
                        <div class="dfn-wizard-step dfn-step-1 active">
                            ...
                            ?>
                            <div class="dfn-booking-section"<?php if ( $is_single_day ) { echo ' style="display:none;"'; } ?>>
...
function dfn_output_single_product_booking_widget(): void {
    $product_id = get_the_ID();
    if ( $product_id ) {
        echo dfn_render_evento_shortcode( array( 'id' => $product_id ) );
    }
}
